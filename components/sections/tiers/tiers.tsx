...
const Tiers = () => {
    ...
    return (
        <div className="grid grid-cols-10 grid-row-5 pt-14 mt-10 gap-y-8 p-10 pb-0 h-full"> 
            ...
            <div className="hidden lg:block col-span-4 col-start-4 w-full h-3/4 flex flex-col items-center justify-center mb-16 relative top-[-15%]" id="legendary"> 
                    <div className="flex flex-col items-center relative"> 
                        <Image 
                            ...
                            width={275}
                            height={275}
                            className="relative bottom-[-9.5rem]"
                        />
                    </div> 
                    <LegendaryDegenator 
            ...
            <div className="lg:hidden col-span-10 w-full items-center mb-16 flex flex-col top-[-15%]" id="legendary"> 
