...
const HowTo = () => {
    ...
    const cards = [
        ...
        {titleColor: "#FFFFFF", title: "Swap ETH for $DGN", description: "Swap ETH for $DGN by clicking the swap button on Uniswap. There is a 5% buy/sell tax on the token, so make sure to increase the slippage to 5% for a successful swap.", leftAligned: false, imageSrc: "/assets/degenator-new-logo.png"}
    ]
